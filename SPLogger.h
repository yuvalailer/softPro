...
SP_LOGGER_MSG returnMaker(const char* msg, const char* file,
		const char* function, const int line);
/**
 * a simple mechanism for creating hierarchy between the levels.
 * for internal use only.
 *
 * @param level - the logging level.
 * @return
 * 4 	SP_LOGGER_ERROR_LEVEL, //Error level
 * 3	SP_LOGGER_WARNING_ERROR_LEVEL, //Warning level
 * 2	SP_LOGGER_INFO_WARNING_ERROR_LEVEL, //Info level
 * 1	SP_LOGGER_DEBUG_INFO_WARNING_ERROR_LEVEL //Debug level
 *
 */
